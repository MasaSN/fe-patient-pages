...
const ActivityGraph = () => {
  return (
    <div className="col-span-8 overflow-hidden rounded border border-stone-300">
      ...
      {/* Ensure the parent div has a fixed height */}
      <div className="h-64 px-4">
        {/* ResponsiveContainer will automatically adjust to the parent container */}
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Line
              type="monotone"
              dataKey="Returning"
              stroke="#1e40af"  // Lighter shade of blue (sky-800)
  fill="#1e40af"
            />
          </LineChart>
        </ResponsiveContainer>
